...
# create a specific metric for logging how long it takes to get data from the FortiGate(s)
...
# create a metric for the polling saturation KPI
POLLING_INTERVAL_SATURATION = Histogram('fos_metric_polling_interval_saturation',
                                        ...
                                        'A target of 70% or less is desirable.')
